...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "NBS|GAS", meta = (ReturnDisplayName = "ASC"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "NBS|GAS", meta = (DefaultToSelf = "AbilityOwner", ReturnDisplayName = "Activations"))
	 ...
	 * @return					The number of successful ability activations triggered by the event.
	 */
	UFUNCTION(BlueprintCallable, Category = "NBS|GAS", meta = (ReturnDisplayName = "Activations"))
	 ...
	 */	
	UFUNCTION(BlueprintCallable, BlueprintCosmetic, Category = "NBS|GAS", meta = (AutoCreateRefTerm = "GameplayCueParameters"))
