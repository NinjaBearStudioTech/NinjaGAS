...
#include "NinjaGASPawn.h"
#include "NinjaGASPlayerPawn.generated.h"

/**
 * A specialized class that will obtain the Ability System Component from the Player State.
 */
UCLASS(Abstract)
class NINJAGAS_API ANinjaGASPlayerPawn : public ANinjaGASPawn
{
	GENERATED_BODY()

public:
	
	ANinjaGASPlayerPawn(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
private:
	...
	/** Weak reference to the Pawn's Ability Component. */
	TWeakObjectPtr<UNinjaGASAbilitySystemComponent> PawnAbilitiesPtr;
